...
FILES_TO_UPLOAD = [
    ...
    "JULES_SCHEDULED_TASKS_GUIDE.md",
    "SPARK_SCHEDULED_TASK_GUIDE.md",
    ...
    "data/knowledge/claims_cmre.json",
    "data/knowledge/postmortems_failures_catalog.json",
    "data/knowledge/decision_matrix_engine.json",
    "data/knowledge/sample_submissions_catalog.json",
